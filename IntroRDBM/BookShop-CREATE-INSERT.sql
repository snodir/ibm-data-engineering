...
--CREATE DATABASE IntroRDBMS;
--GO
USE IntroRDBMS;

DROP TABLE IF EXISTS dbo.BookShop;
DROP TABLE IF EXISTS dbo.BookShop_AuthorDetails;
...
INSERT INTO dbo.BookShop_AuthorDetails
...
SELECT *
FROM dbo.BookShop_AuthorDetails;
